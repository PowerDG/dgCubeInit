...
namespace dgCube.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly dgCubeDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = dgCubeConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(dgCubeDbContext context)
        {
            _context = context;
        }
