...
{
    [DbContext(typeof(dgCubeDbContext))]
    [Migration("20210316094230_infoEnterprisesCardJson")]
    partial class infoEnterprisesCardJson
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dgCube.ApplicationInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("DeleteUserId")
                        .HasColumnType("integer")
                        .HasColumnName("delete_userid");

                    b.Property<string>("EnterprisesCardJson")
                        .HasColumnType("text")
                        .HasColumnName("enterprises_card");
            ...
            modelBuilder.Entity("dgCube.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("dgCube.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("dgCube.ExternalSMLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("LogScource")
                        .HasColumnType("text")
                        .HasColumnName("log_scource");
                    ...
                    b.ToTable("ExternalSMLogs");
                });

            modelBuilder.Entity("dgCube.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("dgCube.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("dgCube.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("dgCube.Authorization.Roles.Role", b =>
                {
                    b.HasOne("dgCube.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("dgCube.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("dgCube.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
