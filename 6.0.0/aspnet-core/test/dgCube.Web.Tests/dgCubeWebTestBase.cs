...
{
    public abstract class dgCubeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static dgCubeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(dgCubeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<dgCubeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<dgCubeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<dgCubeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<dgCubeDbContext, Task<T>> func)
        {
            T result;
